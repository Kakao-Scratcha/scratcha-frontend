...
// 색상 팔레트 (다중 라인용)
const COLORS = [
    'rgb(96 165 250)',   // 밝은 파란색 (전체) - 다크 모드 대비 개선
    'rgb(52 211 153)',   // 밝은 초록색 - 다크 모드 대비 개선
    'rgb(251 191 36)',   // 밝은 주황색 - 다크 모드 대비 개선
    'rgb(248 113 113)',  // 밝은 빨간색 - 다크 모드 대비 개선
    'rgb(167 139 250)',  // 밝은 보라색 - 다크 모드 대비 개선
    'rgb(249 168 212)',  // 밝은 핑크색 - 다크 모드 대비 개선
];
