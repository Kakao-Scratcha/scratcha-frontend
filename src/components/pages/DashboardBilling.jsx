                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="lg:col-span-2">
                                <div className="grid grid-cols-2 gap-3 h-full">
                                    {/* 오늘 사용량 */}
                                    <div className="flex items-center justify-between p-4 bg-green-50 dark:bg-green-900/20 rounded-lg h-full border border-green-200 dark:border-green-800">
                                        <div>
                                    ...
                                    {/* 이번 주 사용량 */}
                                    <div className="flex items-center justify-between p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg h-full border border-orange-200 dark:border-orange-800">
                                        <div>
                                    ...
                                    {/* 이번 달 사용량 */}
                                    <div className="flex items-center justify-between p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg h-full border border-purple-200 dark:border-purple-800">
                                        <div>
