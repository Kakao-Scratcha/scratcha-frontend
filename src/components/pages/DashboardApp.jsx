        ...
        try {
            ...
            for (const apiKey of appApiKeys) {
                try {
                    ...
                    devLog('✅ API 키 난이도 업데이트 성공:', { keyId: apiKey.id, difficulty: tempDifficulty });
                } catch (error) {
            ...
            <div className="space-y-6">
                ...
                {(loading || isAppsLoading) ? (
                    <div className="text-center py-12">
                        ...
                        <p className="mt-4 text-gray-600 dark:text-gray-400 text-lg">데이터를 불러오는 중...</p>
                    </div>
                ) : (
                    /* ===== 통합 APP 관리 ===== */
